...
PHP_INI_BEGIN()
	...
	STD_PHP_INI_ENTRY("input_encoding",			"",			PHP_INI_ALL,	OnUpdateString,			default_charset,		sapi_globals_struct,sapi_globals)
	STD_PHP_INI_ENTRY("internal_encoding",		SAPI_DEFAULT_CHARSET,	PHP_INI_ALL,	OnUpdateString,	default_charset,	sapi_globals_struct,sapi_globals)
	STD_PHP_INI_ENTRY("output_encoding",		"",			PHP_INI_ALL,	OnUpdateString,			default_charset,		sapi_globals_struct,sapi_globals)
